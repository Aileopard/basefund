...
import com.leo.common.server.exceptionhandler.GuliException;
import com.leo.fundservice.model.Role;
import com.leo.fundservice.model.FundUser;
import com.leo.fundservice.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        if (null == user) {
            throw new GuliException(0, "无改用户");
        }
